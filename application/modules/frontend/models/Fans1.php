...
class Frontend_Model_Fans extends Zend_Db_Table_Abstract {
    ...
    protected $_insert_fields = array(
        ...
        'vCity' => 'varchar',
        'vZipcode' => 'varchar',
        'eShip_same_bill' => 'varchar',
        'vShip_name' => 'varchar',
        'vShip_lastname' => 'varchar',
        'vShip_address' => 'varchar',
        'vShip_address2' => 'varchar',
        'vShip_city' => 'varchar',
        'vShip_country' => 'varchar',
        'vShip_state' => 'varchar',
        'vShip_zipcode' => 'varchar',
        'vPhone' => 'varchar',
        'vWebsite' => 'varchar',
        'eNewslater' => 'varchar',
        'vFax'=>'varchar',
