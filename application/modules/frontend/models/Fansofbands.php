...
class Frontend_Model_Fansofbands extends Zend_Db_Table_Abstract {
...
//    }
    ...
    public function hashPassword( $password ) {
        ...
        $select->from(array('m' => 'members'),array('iId','vEmail'))
                ->joinLeft(array('b' => 'bands'), 'b.iMember_id = m.iId',array('iBand_id'=>'iId','vTitle'));
        if ($whereCondition) {
