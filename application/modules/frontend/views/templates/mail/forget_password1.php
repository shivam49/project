...
<div>
<a href="http://www.8bitinc.com/projectx/forget-password/confirm/mail/<?php echo $this->user_list['vEmail'];?>/act/c/key/<?php echo $this->user_list['password']; ?>/security/<?php echo $this->user_list['security']; ?>">Click here to confirm your new password!</a>
</div>
<div>
